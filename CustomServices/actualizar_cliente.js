...
export default function actualizar_cliente(){
    let schema_personal = {
        ...
        fields:[
            ...
            {id: 'celular', required: 'si', description: 'Numero de celular', type:'number'},
            {id: 'telefono', required: 'si', description: 'Numero de telefono domiciliar', type:'number'},
    ...
    let schema_laboral = {
        ...
        fields: [
            ...
            {id: 'telefono_empresa', required: 'si',  description: 'Telefono de la empresa', type: 'number'},
    ...
    let schema_negocio = {
        ...
        fields: [
            ...
            {id: 'telefono_negocio', required: 'si',  description: 'Telefono del negocio', type: 'number'},
    ...
    let schema_otros = {
        title: 'Ingreso Negocio', 
        fields: [
            {id: 'ingreso_remesas', required: 'si', description: 'Ingreso mensual por remesas familiares', type:'money'},
            {id: 'ingreso_jubilacion', required: 'si', description: 'Ingreso mensual por jubilación o pensión', type:'money'},
            {id: 'ingreso_servicios', required: 'si', description: 'Ingreso mensual por servicios profesionales', type: 'money'},
            {id: 'ingreso_alquiler', required: 'si',  description: 'Ingreso mensual por alquiler o rentas', type: 'money'},
